...
addon = xbmcaddon.Addon('script.wikipedia')
lang_index = int(addon.getSetting('language'))
languages = ['aa', 'ab', 'ace', 'ady', 'af', 'ak', 'alt', 'am', 'ami', 'an', 'ang', 'ann', 'anp', 'ar', 'arc', 'ary', 'arz', 'as', 'ast', 'atj', 'av', 'avk', 'awa', 'ay', 'az', 'azb', 'ba', 'ban', 'bar', 'bbc', 'bcl', 'bdr', 'be', 'be-tarask', 'bew', 'bg', 'bh', 'bi', 'bjn', 'blk', 'bm', 'bn', 'bo', 'bpy', 'br', 'bs', 'btm', 'bug', 'bxr', 'ca', 'cbk-zam', 'cdo', 'ce', 'ceb', 'ch', 'cho', 'chr', 'chy', 'ckb', 'co', 'cr', 'crh', 'cs', 'csb', 'cu', 'cv', 'cy', 'da', 'dag', 'de', 'dga', 'din', 'diq', 'dsb', 'dtp', 'dty', 'dv', 'dz', 'ee', 'el', 'eml', 'en', 'eo', 'es', 'et', 'eu', 'ext', 'fa', 'fat', 'ff', 'fi', 'fj', 'fo', 'fon', 'fr', 'frp', 'frr', 'fur', 'fy', 'ga', 'gag', 'gan', 'gcr', 'gd', 'gl', 'glk', 'gn', 'gom', 'gor', 'got', 'gpe', 'gsw', 'gu', 'guc', 'gur', 'guw', 'gv', 'ha', 'hak', 'haw', 'he', 'hi', 'hif', 'ho', 'hr', 'hsb', 'ht', 'hu', 'hy', 'hyw', 'hz', 'ia', 'iba', 'id', 'ie', 'ig', 'igl', 'ii', 'ik', 'ilo', 'inh', 'io', 'is', 'it', 'iu', 'ja', 'jam', 'jbo', 'jv', 'ka', 'kaa', 'kab', 'kbd', 'kbp', 'kcg', 'kg', 'kge', 'ki', 'kj', 'kk', 'kl', 'km', 'kn', 'knc', 'ko', 'koi', 'kr', 'krc', 'ks', 'ksh', 'ku', 'kus', 'kv', 'kw', 'ky', 'la', 'lad', 'lb', 'lbe', 'lez', 'lfn', 'lg', 'li', 'lij', 'lld', 'lmo', 'ln', 'lo', 'lrc', 'lt', 'ltg', 'lv', 'lzh', 'mad', 'mai', 'map-bms', 'mdf', 'mg', 'mh', 'mhr', 'mi', 'min', 'mk', 'ml', 'mn', 'mni', 'mnw', 'mos', 'mr', 'mrj', 'ms', 'mt', 'mus', 'mwl', 'my', 'myv', 'mzn', 'na', 'nah', 'nan', 'nap', 'nds', 'nds-nl', 'ne', 'new', 'ng', 'nia', 'nl', 'nn', 'no', 'nov', 'nqo', 'nr', 'nrm', 'nso', 'nup', 'nv', 'ny', 'oc', 'olo', 'om', 'or', 'os', 'pa', 'pag', 'pam', 'pap', 'pcd', 'pcm', 'pdc', 'pfl', 'pi', 'pih', 'pl', 'pms', 'pnb', 'pnt', 'ps', 'pt', 'pwn', 'qu', 'rm', 'rmy', 'rn', 'ro', 'roa-tara', 'rsk', 'ru', 'rue', 'rup', 'rw', 'sa', 'sah', 'sat', 'sc', 'scn', 'sco', 'sd', 'se', 'sg', 'sgs', 'sh', 'shi', 'shn', 'si', 'simple', 'sk', 'skr', 'sl', 'sm', 'smn', 'sn', 'so', 'sq', 'sr', 'srn', 'ss', 'st', 'stq', 'su', 'sv', 'sw', 'syl', 'szl', 'szy', 'ta', 'tay', 'tcy', 'tdd', 'te', 'tet', 'tg', 'th', 'ti', 'tig', 'tk', 'tl', 'tly', 'tn', 'to', 'tpi', 'tr', 'trv', 'ts', 'tt', 'tum', 'tw', 'ty', 'tyv', 'udm', 'ug', 'uk', 'ur', 'uz', 've', 'vec', 'vep', 'vi', 'vls', 'vo', 'vro', 'wa', 'war', 'wo', 'wuu', 'xal', 'xh', 'xmf', 'yi', 'yo', 'yue', 'za', 'zea', 'zgh', 'zh', 'zu']
language_code = languages[lang_index]
...
WIKI_LANGUAGE = {'aa': 'aa', 'ab': 'ab', 'ace': 'ace', 'ady': 'ady', 'af': 'af', 'ak': 'ak', 'alt': 'alt', 'am': 'am', 'ami': 'ami', 'an': 'an', 'ang': 'ang', 'ann': 'ann', 'anp': 'anp', 'ar': 'ar', 'arc': 'arc', 'ary': 'ary', 'arz': 'arz', 'as': 'as', 'ast': 'ast', 'atj': 'atj', 'av': 'av', 'avk': 'avk', 'awa': 'awa', 'ay': 'ay', 'az': 'az', 'azb': 'azb', 'ba': 'ba', 'ban': 'ban', 'bar': 'bar', 'bbc': 'bbc', 'bcl': 'bcl', 'bdr': 'bdr', 'be': 'be', 'be-tarask': 'be-tarask', 'bew': 'bew', 'bg': 'bg', 'bh': 'bh', 'bi': 'bi', 'bjn': 'bjn', 'blk': 'blk', 'bm': 'bm', 'bn': 'bn', 'bo': 'bo', 'bpy': 'bpy', 'br': 'br', 'bs': 'bs', 'btm': 'btm', 'bug': 'bug', 'bxr': 'bxr', 'ca': 'ca', 'cbk-zam': 'cbk-zam', 'cdo': 'cdo', 'ce': 'ce', 'ceb': 'ceb', 'ch': 'ch', 'cho': 'cho', 'chr': 'chr', 'chy': 'chy', 'ckb': 'ckb', 'co': 'co', 'cr': 'cr', 'crh': 'crh', 'cs': 'cs', 'csb': 'csb', 'cu': 'cu', 'cv': 'cv', 'cy': 'cy', 'da': 'da', 'dag': 'dag', 'de': 'de', 'dga': 'dga', 'din': 'din', 'diq': 'diq', 'dsb': 'dsb', 'dtp': 'dtp', 'dty': 'dty', 'dv': 'dv', 'dz': 'dz', 'ee': 'ee', 'el': 'el', 'eml': 'eml', 'en': 'en', 'eo': 'eo', 'es': 'es', 'et': 'et', 'eu': 'eu', 'ext': 'ext', 'fa': 'fa', 'fat': 'fat', 'ff': 'ff', 'fi': 'fi', 'fj': 'fj', 'fo': 'fo', 'fon': 'fon', 'fr': 'fr', 'frp': 'frp', 'frr': 'frr', 'fur': 'fur', 'fy': 'fy', 'ga': 'ga', 'gag': 'gag', 'gan': 'gan', 'gcr': 'gcr', 'gd': 'gd', 'gl': 'gl', 'glk': 'glk', 'gn': 'gn', 'gom': 'gom', 'gor': 'gor', 'got': 'got', 'gpe': 'gpe', 'gsw': 'gsw', 'gu': 'gu', 'guc': 'guc', 'gur': 'gur', 'guw': 'guw', 'gv': 'gv', 'ha': 'ha', 'hak': 'hak', 'haw': 'haw', 'he': 'he', 'hi': 'hi', 'hif': 'hif', 'ho': 'ho', 'hr': 'hr', 'hsb': 'hsb', 'ht': 'ht', 'hu': 'hu', 'hy': 'hy', 'hyw': 'hyw', 'hz': 'hz', 'ia': 'ia', 'iba': 'iba', 'id': 'id', 'ie': 'ie', 'ig': 'ig', 'igl': 'igl', 'ii': 'ii', 'ik': 'ik', 'ilo': 'ilo', 'inh': 'inh', 'io': 'io', 'is': 'is', 'it': 'it', 'iu': 'iu', 'ja': 'ja', 'jam': 'jam', 'jbo': 'jbo', 'jv': 'jv', 'ka': 'ka', 'kaa': 'kaa', 'kab': 'kab', 'kbd': 'kbd', 'kbp': 'kbp', 'kcg': 'kcg', 'kg': 'kg', 'kge': 'kge', 'ki': 'ki', 'kj': 'kj', 'kk': 'kk', 'kl': 'kl', 'km': 'km', 'kn': 'kn', 'knc': 'knc', 'ko': 'ko', 'koi': 'koi', 'kr': 'kr', 'krc': 'krc', 'ks': 'ks', 'ksh': 'ksh', 'ku': 'ku', 'kus': 'kus', 'kv': 'kv', 'kw': 'kw', 'ky': 'ky', 'la': 'la', 'lad': 'lad', 'lb': 'lb', 'lbe': 'lbe', 'lez': 'lez', 'lfn': 'lfn', 'lg': 'lg', 'li': 'li', 'lij': 'lij', 'lld': 'lld', 'lmo': 'lmo', 'ln': 'ln', 'lo': 'lo', 'lrc': 'lrc', 'lt': 'lt', 'ltg': 'ltg', 'lv': 'lv', 'lzh': 'lzh', 'mad': 'mad', 'mai': 'mai', 'map-bms': 'map-bms', 'mdf': 'mdf', 'mg': 'mg', 'mh': 'mh', 'mhr': 'mhr', 'mi': 'mi', 'min': 'min', 'mk': 'mk', 'ml': 'ml', 'mn': 'mn', 'mni': 'mni', 'mnw': 'mnw', 'mos': 'mos', 'mr': 'mr', 'mrj': 'mrj', 'ms': 'ms', 'mt': 'mt', 'mus': 'mus', 'mwl': 'mwl', 'my': 'my', 'myv': 'myv', 'mzn': 'mzn', 'na': 'na', 'nah': 'nah', 'nan': 'nan', 'nap': 'nap', 'nds': 'nds', 'nds-nl': 'nds-nl', 'ne': 'ne', 'new': 'new', 'ng': 'ng', 'nia': 'nia', 'nl': 'nl', 'nn': 'nn', 'no': 'no', 'nov': 'nov', 'nqo': 'nqo', 'nr': 'nr', 'nrm': 'nrm', 'nso': 'nso', 'nup': 'nup', 'nv': 'nv', 'ny': 'ny', 'oc': 'oc', 'olo': 'olo', 'om': 'om', 'or': 'or', 'os': 'os', 'pa': 'pa', 'pag': 'pag', 'pam': 'pam', 'pap': 'pap', 'pcd': 'pcd', 'pcm': 'pcm', 'pdc': 'pdc', 'pfl': 'pfl', 'pi': 'pi', 'pih': 'pih', 'pl': 'pl', 'pms': 'pms', 'pnb': 'pnb', 'pnt': 'pnt', 'ps': 'ps', 'pt': 'pt', 'pwn': 'pwn', 'qu': 'qu', 'rm': 'rm', 'rmy': 'rmy', 'rn': 'rn', 'ro': 'ro', 'roa-tara': 'roa-tara', 'rsk': 'rsk', 'ru': 'ru', 'rue': 'rue', 'rup': 'rup', 'rw': 'rw', 'sa': 'sa', 'sah': 'sah', 'sat': 'sat', 'sc': 'sc', 'scn': 'scn', 'sco': 'sco', 'sd': 'sd', 'se': 'se', 'sg': 'sg', 'sgs': 'sgs', 'sh': 'sh', 'shi': 'shi', 'shn': 'shn', 'si': 'si', 'simple': 'simple', 'sk': 'sk', 'skr': 'skr', 'sl': 'sl', 'sm': 'sm', 'smn': 'smn', 'sn': 'sn', 'so': 'so', 'sq': 'sq', 'sr': 'sr', 'srn': 'srn', 'ss': 'ss', 'st': 'st', 'stq': 'stq', 'su': 'su', 'sv': 'sv', 'sw': 'sw', 'syl': 'syl', 'szl': 'szl', 'szy': 'szy', 'ta': 'ta', 'tay': 'tay', 'tcy': 'tcy', 'tdd': 'tdd', 'te': 'te', 'tet': 'tet', 'tg': 'tg', 'th': 'th', 'ti': 'ti', 'tig': 'tig', 'tk': 'tk', 'tl': 'tl', 'tly': 'tly', 'tn': 'tn', 'to': 'to', 'tpi': 'tpi', 'tr': 'tr', 'trv': 'trv', 'ts': 'ts', 'tt': 'tt', 'tum': 'tum', 'tw': 'tw', 'ty': 'ty', 'tyv': 'tyv', 'udm': 'udm', 'ug': 'ug', 'uk': 'uk', 'ur': 'ur', 'uz': 'uz', 've': 've', 'vec': 'vec', 'vep': 'vep', 'vi': 'vi', 'vls': 'vls', 'vo': 'vo', 'vro': 'vro', 'wa': 'wa', 'war': 'war', 'wo': 'wo', 'wuu': 'wuu', 'xal': 'xal', 'xh': 'xh', 'xmf': 'xmf', 'yi': 'yi', 'yo': 'yo', 'yue': 'yue', 'za': 'za', 'zea': 'zea', 'zgh': 'zgh', 'zh': 'zh', 'zu': 'zu'}
...
class WikipediaGUI(xbmcgui.WindowXMLDialog):
    def __init__(self, *args, **kwargs):
        ...
        self._wiki = WikipediaAPI(language=language_code)
